...
namespace ConsoleApp.EF.Migrations.Data.Configuration
{
    public static class SeedData
    {
        ...
        {
          new Schedule { Id = 1, Title = SchedulEnums.Daily, SUN = true, MON = true, TUE = true, WED = true, THU = true, FRI = false, SAT = false },
          new Schedule { Id = 2, Title = SchedulEnums.DayAfterDay, SUN = true, MON = false, TUE = true, WED = false, THU = true, FRI = false, SAT = false },
          new Schedule { Id = 3, Title = SchedulEnums.TwiceAWeek, SUN = false, MON = true, TUE = false, WED = true, THU = false, FRI = false, SAT = false },
          new Schedule { Id = 4, Title = SchedulEnums.Weekend, SUN = false, MON = false, TUE = false, WED = false, THU = false, FRI = true, SAT = true },
          new Schedule { Id = 5, Title = SchedulEnums.Compact, SUN = true, MON = true, TUE = true, WED = true, THU = true, FRI = true, SAT = true }
        };
        ...
        public static List<Corporate> LoadCorporates() => new List<Corporate>()
        {
        ...
        public static List<Individual> LoadIndividuals() => new List<Individual>()
        {
            new Individual { Id = 1, FName = "Fatima", LName = "Ali",University = "XYZ", YearOfGraduate = 2024, IsEntern= false },
            new Individual { Id = 3, FName = "Omar", LName = "Youssef", University = "POQ", YearOfGraduate = 2023, IsEntern = true },
            new Individual { Id = 5, FName = "Amira", LName = "Tariq", University = "POQ", YearOfGraduate = 2025, IsEntern = false },
            new Individual { Id = 6, FName = "Zainab", LName = "Ismail", University = "POQ", YearOfGraduate = 2023, IsEntern = true },
            new Individual { Id = 9, FName = "Mohammed", LName = "Adel", University = "XYZ", YearOfGraduate = 2024, IsEntern = false },
            new Individual { Id = 10, FName = "Samira", LName = "Nabil", University = "XYZ", YearOfGraduate = 2024, IsEntern = false }
        };
